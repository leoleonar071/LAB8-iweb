...
public class Persona {
    ...
    public void setProduccionMoral(int produccionMoral) {
    ...
    public int getTiempo_en_colonia() {
        return tiempo_en_colonia;
    }

    public void setTiempo_en_colonia(int tiempo_en_colonia) {
        this.tiempo_en_colonia = tiempo_en_colonia;
    }
