...
<body-form>
    ...
    background: radial-gradient(circle, rgba(255, 255, 0, 1) 0%, rgba(255, 102, 0, 1) 100%) !important;">
        <div class="text-secondary px-4 py-2 text-center">
            <div style="padding-bottom: 20px; padding-top: 30px">
                <h1 class="display-5 fw-bold text-black" style="color: #292826">Edición de Persona</h1>
    ...
    <div class="container">
        ...
        <h2><i class="fa-solid fa-star" style="color: #8de7ef;"></i><strong style="padding-left: 10px">Interfaz de Edición de Persona</strong></h2>
